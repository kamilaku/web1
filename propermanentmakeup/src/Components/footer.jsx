    ...
    return (
        <footer className="row py-4">
            ...
            <div className='d-flex justify-content-center col'>
                <ul className="nav flex-nowrap col-md-4 d-flex justify-content-center list-unstyled d-flex">
                    <li className="ms-3"><a className="text-body-secondary" href="https://www.instagram.com/magdalena.deja.akademia.piekna/"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <li className="ms-3"><a className="text-body-secondary" href="https://www.facebook.com/AkademiaPieknaM.Deja"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
