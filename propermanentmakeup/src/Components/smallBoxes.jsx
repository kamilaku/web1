    ...
    return (
        <div className="row">
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 d-flex flex-column">
                ...
                <h2 className="fw-normal d-flex justify-content-center p-3">Kreski</h2>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 d-flex flex-column">
                ...
                <h2 className="fw-normal d-flex justify-content-center p-3">Usta</h2>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 d-flex flex-column">
                ...
                <h2 className="fw-normal d-flex justify-content-center p-3">Brwi</h2>
