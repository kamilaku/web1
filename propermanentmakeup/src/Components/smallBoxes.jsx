...
const SmallBoxes = () => {
    return (
        <div className="row">
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 d-flex flex-column">
                <Link to="/services/lips" className="d-flex justify-content-center px-2 py-4 link-secondary" ><img src='/images/pic5.jpeg' className="bd-placeholder-img rounded object-fit-cover img-dotted" width="140" height="140" /></Link>
            ...
            <div className="col-xs-12 col-sm-6 col-md-4 d-flex flex-column">
                <Link to="/services/brows" className="d-flex justify-content-center px-2 py-4 link-secondary" ><img src='/images/pic4.jpeg' className="bd-placeholder-img rounded object-fit-cover img-dotted" width="140" height="140" /></Link>
