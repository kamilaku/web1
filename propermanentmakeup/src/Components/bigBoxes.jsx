    ...
    return (<>
        ...
        <div className="row featurette">
            <div className="col-md-7">
                <h2 className="featurette-heading fw-normal lh-1">Akademia Piękna Magdalena Deja 
                <br></br><span className="text-body-secondary">Centrum makijażu permanentnego w Jeleniej Górze</span></h2>
        ...
        <div className="row featurette">
            <div className="col-md-7 order-md-2">
                <h2 className="featurette-heading fw-normal lh-1">Magdalena Deja 
                <br></br><span className="text-body-secondary">Linergistka z wieloletnim doświadczeniem</span></h2>
