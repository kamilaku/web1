const Removal = () => {
    return(
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading fw-normal lh-1">Usuwanie makijażu permanentnego i tatuaży 
                <br/><span class="text-body-secondary">strona w budowie</span></h2>
                <p class="lead">strona w budowie</p>
            </div>
            <div class="col-md-5">
